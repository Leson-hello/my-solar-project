...
public class DataLoader implements CommandLineRunner {
    ...
    private void createSampleNews() {
        // Sample News 1
        News news1 = new News();
        news1.setTitle("DAT Group Hợp Tác Với Lithium Valley - Lưu Trữ Điện Dân Dụng");
        news1.setShortDescription("Trong bối cảnh nhu cầu lưu trữ điện mặt trời ngày càng tăng, DAT Group và Lithium Valley thời gian qua tích cực hợp tác để đem lại giải pháp pin lưu trữ tối ưu cho khách hàng.");
        news1.setContent("<p>Thời gian gần đây, nhu cầu sử dụng hệ thống lưu trữ năng lượng ngày càng tăng cao. Việc kết hợp hệ thống điện mặt trời với pin lưu trữ không chỉ giúp tối ưu hóa hiệu suất sử dụng điện mà còn đảm bảo nguồn cung cấp điện ổn định 24/7.</p>" +
                ...
                "<p>DAT Group cam kết mang đến những sản phẩm và dịch vụ tốt nhất cho khách hàng trong lĩnh vực năng lượng tái tạo.</p>");
        news1.setImageUrl("/photo/anh39.jpg");
        news1.setAuthor("Admin DAT");
        ...
        news2.setShortDescription("Theo báo cáo mới nhất, năng lượng mặt trời đang trở thành xu hướng chủ đạo trong việc chuyển đổi năng lượng toàn cầu.");
        news2.setContent("<p>Năng lượng mặt trời đã và đang khẳng định vị thế là nguồn năng lượng của tương lai. Với những tiến bộ vượt bậc trong công nghệ và sự giảm giá đáng kể của các tấm pin mặt trời, ngành công nghiệp này đang chứng kiến sự tăng trưởng mạnh mẽ.</p>" +
        ...
        news3.setShortDescription("Breakthrough trong công nghệ pin mặt trời với hiệu suất chuyển đổi năng lượng đạt 25%, mở ra kỷ nguyên mới cho năng lượng tái tạo.");
        news3.setContent("<p>Các nhà nghiên cứu vừa công bố thành công trong việc phát triển công nghệ pin mặt trời thế hệ mới với hiệu suất chuyển đổi năng lượng lên đến 25%. Đây là bước tiến quan trọng trong ngành năng lượng tái tạo.</p>" +
        ...
        news4.setShortDescription("DAT Group hoàn thành thành công dự án điện mặt trời áp mái công suất 2.5MW tại Nhà máy Saitex, góp phần tiết kiệm chi phí điện cho doanh nghiệp.");
        news4.setContent("<p>Dự án điện mặt trời áp mái tại Nhà máy Saitex 5 & 6 được DAT Group triển khai và hoàn thành thành công với tổng công suất 2.5MW. Đây là một trong những dự án điển hình cho việc ứng dụng năng lượng mặt trời trong sản xuất công nghiệp.</p>" +
        ...
        news5.setShortDescription("Bài viết hướng dẫn chi tiết các bước lắp đặt hệ thống điện mặt trời cho hộ gia đình, từ khảo sát đến vận hành.");
        news5.setContent("<p>Việc lắp đặt hệ thống điện mặt trời cho hộ gia đình cần tuân thủ đúng quy trình để đảm bảo hiệu quả và an toàn.</p>" +
        ...
        news6.setShortDescription("Theo báo cáo thị trường, ngành năng lượng mặt trời Việt Nam đạt mức tăng trường 45% trong năm 2024, dẫn đầu khu vực Đông Nam Á.");
        news6.setContent("<p>Thị trường năng lượng mặt trời Việt Nam đang chứng kiến sự tăng trưởng ấn tượng với mức tăng 45% so với năm trước. Đây là tín hiệu tích cực cho ngành năng lượng tái tạo trong nước.</p>" +
